...
namespace TechStore.Domain.Constants
{
    public static class EmailTemplates
    {
        ...
        public static string GetLoginVerificationOptionsEmailBody(string fullName, string verifyDeviceLink, string sendOtpLink)
        {
            return $@"
<div style=""font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 30px; background-color: #0f172a; color: #f8fafc; border-radius: 16px; box-shadow: 0 10px 25px rgba(0, 0, 0, 0.3); border: 1px solid #1e293b;"">
    ...
    <div style=""background: linear-gradient(135deg, #1e293b 0%, #0f172a 100%); padding: 25px; border-radius: 12px; border: 1px solid #334155; margin-bottom: 30px;"">
        ...
        <p style=""color: #cbd5e1; line-height: 1.6; font-size: 15px;"">Chúng tôi đã nhận được yêu cầu đăng nhập vào tài khoản của bạn. Để bảo vệ tài khoản, vui lòng chọn một trong hai phương thức xác thực dưới đây để hoàn tất đăng nhập:</p>
    </div>

    <div style=""margin-bottom: 30px;"">
        <!-- Option A -->
        <div style=""background-color: #1e293b; padding: 20px; border-radius: 12px; border-left: 4px solid #38bdf8; margin-bottom: 20px;"">
            <h4 style=""color: #38bdf8; margin: 0 0 10px 0; font-size: 16px; font-weight: 600;"">Lựa chọn A: Xác thực thiết bị nhanh</h4>
            <p style=""color: #94a3b8; font-size: 14px; line-height: 1.5; margin: 0 0 15px 0;"">Nhấn vào nút bên dưới để xác nhận thiết bị này là tin cậy và tự động hoàn tất đăng nhập.</p>
            <a href=""{verifyDeviceLink}"" style=""display: inline-block; background: linear-gradient(90deg, #0284c7 0%, #0369a1 100%); color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px; transition: all 0.3s ease; box-shadow: 0 4px 12px rgba(2, 132, 199, 0.3);"">Xác thực thiết bị</a>
        </div>

        <!-- Option B -->
        <div style=""background-color: #1e293b; padding: 20px; border-radius: 12px; border-left: 4px solid #f59e0b;"">
            <h4 style=""color: #f59e0b; margin: 0 0 10px 0; font-size: 16px; font-weight: 600;"">Lựa chọn B: Nhận mã OTP</h4>
            <p style=""color: #94a3b8; font-size: 14px; line-height: 1.5; margin: 0 0 15px 0;"">Nếu bạn muốn nhập mã xác thực thủ công trên thiết bị hiện tại, hãy nhấn nút dưới đây để nhận mã OTP qua email.</p>
            <a href=""{sendOtpLink}"" style=""display: inline-block; background: linear-gradient(90deg, #d97706 0%, #b45309 100%); color: #ffffff; text-decoration: none; padding: 12px 24px; border-radius: 8px; font-weight: 600; font-size: 14px; transition: all 0.3s ease; box-shadow: 0 4px 12px rgba(217, 119, 6, 0.3);"">Nhận mã OTP</a>
        </div>
    </div>
